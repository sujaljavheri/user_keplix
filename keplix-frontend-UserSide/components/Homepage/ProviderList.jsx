...
const ProviderList = ({ navigation }) => {
  ...
  const dummyData = [
    ...
    },
    {
      id: "6",
      name: "Express Wash",
      description: "Quick 30-min service",
      price: "From ₹490",
      icon: "timer",
    },
  ];
  ...
  const renderServiceCard = ({ item }) => (
    <TouchableOpacity
      style={styles.card}
      onPress={() => navigation.navigate("ServiceData", { service: item })}
    >
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.background}>
        ...
        <Text style={styles.headerTitle}>Car Cleaning</Text>
        <View style={{ width: 24 }} />
      </View>

      {/* ✅ Unified Search Bar (same as ServiceData.jsx) */}
...
const styles = StyleSheet.create({
  ...
  // ✅ Same search bar style as ServiceData
  searchContainer: {
    flexDirection: "row",
    alignItems: "center",
    marginBottom: 16,
  ...
  description: { fontSize: 12, color: "#666", marginBottom: 6 },
  price: { fontSize: 12, fontWeight: "600", color: "#D10000" },
});
